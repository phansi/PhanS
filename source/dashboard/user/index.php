    ...
    <form  method="post"  enctype="multipart/form-data">
        ...
        <div class="col-md-12 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                <?php
                    $getuser= json_decode(getUser(3));
                  foreach($getuser as $userad) {?>
                     <div class="col-md-12"><label for="firstname"class="labels">First name </label>
                     <input name="firstname" type="text" class="form-control" value="<?= $userad->firstname ?>"></div>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['up'])) {
                                ...
                                if($tk1<500000){
                                    ...
                                    echo "<div class='alert alert-success text-center'>Upgrade success,please log out and log back in to use developer functions!!</div>";
                                    exit();
                                }
                    }
                    ?>
