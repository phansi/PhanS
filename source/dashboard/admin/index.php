...
?>
<!--Update web khong can reloading-->
<!DOCTYPE html>
<html lang="en">
            ...
            <ul>
                ...
                <li>
                    <a class="<?php if(isset($_GET['page']) && $_GET['page'] == 'transaction'){echo 'active';}?>" href="?page=transaction"><Span class="fas fa-money-bill-wave"></Span>
                        <Span id ="Transaction">Transaction </Span> </a>
                </li>
                <li>
...
$(function(){
    ...
    var spinner = get.getElementById("avatar");
    // specify the server/url you want to load data from
    var url = "http://localhost/phpmyadmin/index.php?route=/sql&pos=0&db=appstore&table=account";
    ...
    <div class="main-content">
        ...
        <header>
            ...
            <div class="user-wrapper" id="avatar">
             <?php
                ...
                <div>
                    ...
                    <small>Admin</small>
                    <small>Wallet:<?= $userad->wallet?> VNĐ</small>
                </div>
            <?php } 
            ?>
            </div>
                                ...
                                foreach($getNormalUsers as $users) {?>
                                    <tr>
                                        ...
                                        <form method="POST"> 
                                            ...
                                            <button type="submit" name="removeuseremail" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                foreach($getNormalUsers as $users) {?>
                                    <tr>
                                        ...
                                        <form method="POST"> 
                                            ...
                                            <button type="submit" name="removedeveloperemail" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                ...
                                foreach($getApps as $app) {?>
                                    <tr>
                                        ...
                                        <form method="POST"> 
                                            ...
                                            <button type="submit" name="removeApp" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                foreach($getApps as $app) {?>
                                    <tr>
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="acpt_submit" class="btn btn-success btn-sm"><i class="fas fa-check-circle"></i></button>
                                            <input type="hidden" name="terminate" value="<?= $app->id ?>">
                                            <button type="submit" name="terminate_submit" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="removeCategory" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>        
                                ...
                                foreach($recharge as $charge) {?>
                                    <tr>
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="removecard" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>    
                                <?php } 
...
<?php if (isset($_GET['page']) && $_GET['page'] == 'transaction') { ?>
                ...
                if(isset($_POST['load']) && isset($_POST['seri'])) {
                    ...
                    $x1 = json_decode(getcard());
                    $x2 = json_decode(getcard12());
                    ...
                    if(empty($seri))
                   {
                       ...
                       foreach($card2 as $c2){
                            ...
                            $money2=$c2->value;
                            if($seri==$seri2){
                                echo "<div class='alert alert-danger text-center'>Card already in use</div>";
                                exit();
                        }                     
                      }
                        foreach($card1 as $c1){
                            ...
                            disablecard($seri1);
                            echo "<div class='alert alert-success text-center'>Loading Successful !</div>";
                            exit();
                            }  
                   }
                        if(in_array($seri,$x1) == false){
                                //echo "<div class='alert alert-danger text-center'>Serial number of card is invalid !</div>";
                                $error = 'Serial number of card is invalid !';
                            }
                        
                   }
       }
       if(isset($_POST['removecard1']) && isset($_POST['serialnumber1'])){
        $serialnumber1 = $_POST['serialnumber1'];
        removecard1($serialnumber1);
    }
           ?>
                            ...
                            <tbody>
                                ...
                                foreach($info as $cc2) {?>
                                    <tr>
                                        ...
                                        <td>
                                        <form method="POST">
                                            <input type="hidden" name="serialnumber1" value="<?=  $cc2-> seri ?>">
                                            <button type="submit" name="removecard1" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
