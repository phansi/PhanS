        ...
        <header>
            ...
            <div class="user-wrapper">
             <?php
                ...
                <img src="../../dashboard/tmpavatar/<?= $userad->avatar ?>" width="40px" height="40px"alt="">
                <div>
                                ...
                                foreach($getApps as $app) {?>
                                    <tr>
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="terminate_submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                foreach($getCategories as $category) {?>
                                    <tr>
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="removeCategory" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                        </form>
                                        </td>
                                    </tr>    
                                <?php } ?>
      ...
      <?php
            ...
            if (isset($_POST['uploadFiles'])) {
                ...
                elseif ($_FILES['download']['error']!=UPLOAD_ERR_OK) {
                    ...
                    newApp($name,$description,$author,$version,$category,1,0,$icon,$download,$price);
                    echo("<meta http-equiv='refresh' content='0'>");
    ...
    <form  method="post"  enctype="multipart/form-data">
        ...
        <div class="col-md-12 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                <?php
                    $getadmin= json_decode(getUser(2));
